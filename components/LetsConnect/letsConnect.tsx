...
function FieldLabel({ id, label, required }: LabelProps) {
    return (
        <label htmlFor={id} className="relative top-3 left-3 inline-flex items-center gap-1 text-[13px] text-[#9769A5] bg-white px-2 border border-[#9769A5] rounded-full">
            {label}
            {required ? <span aria-hidden className="text-red-500 font-bold text-[12px]">*</span> : null}
        </label>
    )
}
...
export default function LetsConnect() {
    ...
    return (
            ...
            <div className="h-max bg-[#9769A5]">
                ...
                <header className="mx-auto max-w-6xl px-6 py-10 text-white">
                    ...
                    >
                        ...
                        <img src="./handHeart.svg" className="w-64 absolute left-[-195px] top-[-77.06px]" />
                    </motion.p>
                </header>
        ...
        */}
            ...
            <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" initial={{ y: -100, opacity: 1 }} whileInView={{ y: 0, opacity: 1 }} transition={{ duration: 1, ease: "easeOut", delay: 0.4 }} viewport={{ once: false }}><path fill="#9769A5" fillOpacity="1" d="M0,192L34.3,197.3C68.6,203,137,213,206,208C274.3,203,343,181,411,186.7C480,192,549,224,617,250.7C685.7,277,754,299,823,277.3C891.4,256,960,192,1029,176C1097.1,160,1166,192,1234,218.7C1302.9,245,1371,267,1406,277.3L1440,288L1440,0L1405.7,0C1371.4,0,1303,0,1234,0C1165.7,0,1097,0,1029,0C960,0,891,0,823,0C754.3,0,686,0,617,0C548.6,0,480,0,411,0C342.9,0,274,0,206,0C137.1,0,69,0,34,0L0,0Z"></path></motion.svg>
        </section>
