        ...
        <section>
            ...
            <div className="h-max bg-[#4AA6B1] px-4 md:px-14 flex flex-col items-center justify-center">
                ...
                <div className='max-w-[1000px] grid md:grid-cols-3 md:grid-rows-1 grid-cols-1 grid-row-3 items-center justify-center text-white text-center gap-16'>
                    <motion.div className='flex flex-col gap-4 justify-center items-center' initial={{ x: -80, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.7, delay: 0.1 }} viewport={{ once: false }}>
                    ...
                    <motion.div className='flex flex-col gap-4 justify-center items-center' initial={{ y: 200, opacity: 0 }}
