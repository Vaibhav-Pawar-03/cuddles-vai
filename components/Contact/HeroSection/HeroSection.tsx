                ...
                <div className='w-full px-4 md:px-0 flex flex-col gap-8'>
                    ...
                    <div className='w-full flex flex-col gap-6 md:px-[5vw]'>
                        <div className='grid md:grid-cols-6 md:grid-rows-2 grid-cols-1 gap-8'>
                            <motion.div className='md:col-span-3 md:row-span-2 border border-[#DE627D] text-[#DE627D] rounded-2xl flex overflow-hidden' whileHover={{ scale: 1.05 }} transition={{ type: 'spring', stiffness: 400, damping: 10 }}>
                        ...
                        <div className='grid md:grid-cols-6 md:grid-rows-2 grid-cols-1 gap-8'>
                            <motion.div className='md:col-span-3 md:row-span-2 border border-[#F0B54C] text-[#F0B54C] rounded-2xl flex overflow-hidden' whileHover={{ scale: 1.05 }} transition={{ type: 'spring', stiffness: 400, damping: 10 }}>
                                <div className='flex flex-col gap-6 w-[800px] p-6'>
