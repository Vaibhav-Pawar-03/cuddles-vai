        ...
        <section className='relative h-max'>
            ...
            <div className="w-full h-max bg-white flex items-center justify-center pt-8">
                <div className='w-full px-4 md:px-0 md:w-[70vw] flex flex-col gap-8'>
                    ...
                    <motion.div className='grid md:grid-cols-3 grid-cols-1 md:grid-rows-1 grid-rows-3 gap-6' >
                        {safetyContentItems.map((item) => {
                            return (
                                <motion.div  key={item.id} className='hover' whileHover={{ scale: 1.1 }}>
                                    <ContentCard title={item.title} description={item.description} image={item.image} imageAlt={item.imageAlt}  />                                
                                </motion.div>
