                ...
                <div className='w-fit flex flex-col gap-4 md:gap-8'>
                    {
                        content.map((item, ind) => {
                            return (
                                <motion.div key={ind} className='flex items-center gap-4 text-white text-2xl max-w-[600px]' initial={{ x: -120, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} transition={{ duration: 0.7, delay: 0.1 * ind }} viewport={{ once: false }}>
